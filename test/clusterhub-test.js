...
exports['test publishing doesnt get caught by the own store subscriber'] = function(done) {
...
exports['test storing data for a client'] = function(done) {
...
exports['test cleaning up clients data'] = function(done) {
...
exports['test cleaning up a particular client'] = function(done) {
  var rand1 = Math.abs(Math.random() * Date.now() | 0)
    , rand2 = Math.abs(Math.random() * Date.now() | 0);
...
exports['test destroy expiration'] = function(done) {
  var store = new HubStore()
